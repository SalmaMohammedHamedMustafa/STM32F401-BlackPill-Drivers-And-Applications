...
#define LCD_4BitDisplayOFF        0x0080  // D = 0    C = 0    B = 0    The Display is Off so Will Cursor is off  And Blinking is OFF
#define LCD_4BitDisplayON         0x00C0  // D = 1    C = 0    B = 0    The Display is On But the Cursor is OFF so the Blinking is OFF
#define LCD_4BitCursorON     	 0x00E0
#define LCD_4BitCursorBlinkON     0x00F0
