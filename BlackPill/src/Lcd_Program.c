...
#if(LcdMode==8)
	//set Direction
	GPIO_voidSetPinDirOutput(Lcd_ControlGroup,Lcd_RsPin,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_ControlGroup,Lcd_RwPin,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_ControlGroup,Lcd_EPin,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,0,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,1,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,2,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,3,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,4,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,5,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,6,PushPull,LowSpeed);
	GPIO_voidSetPinDirOutput(Lcd_DCGroup,7,PushPull,LowSpeed);
	//wait for 30ms
	STK_SetBusyWait(3000000);
